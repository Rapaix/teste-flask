...
rm -rf teste_flask
rm -rf tests
cp -R .github/templates/flask/module teste_flask
...
then
    ...
    echo "then run teste_flask or python -m teste_flask"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run teste_flask or python -m teste_flask or poetry run teste_flask"
fi
